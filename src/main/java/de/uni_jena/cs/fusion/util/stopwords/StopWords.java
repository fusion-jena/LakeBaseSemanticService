package de.uni_jena.cs.fusion.util.stopwords;
...
public class StopWords {
	...
	/**
	 * <p>Freely available stop word list generated by Chris Buckley and Gerard
	 * Salton at Cornell University.</p>
	 * 
	 * <p>Source: http://www.lextek.com/manuals/onix/stopwords2.html</p>
	 * 
	 * <p>Changes: <s>second</s></p>
	 */
	private final static String[] stopWordArray = { "a", "a's", "able", "about", "above", "according", "accordingly",
			...
			"herself", "hi", "him", "himself", "his", "hither", "hopefully", "how", "howbeit", "however", "i", "i'd",
			...
			"it'll", "it's", "its", "itself", "j", "just", "k", "keep", "keeps", "kept", "know", "knows", "known", "l",
			...
			"now", "nowhere", "o", "obviously", "of", "off", "often", "oh", "ok", "okay", "old", "on", "once", "one",
			...
			"respectively", "right", "s", "said", "same", "saw", "say", "saying", "says", "secondly", "see",
	...
	private final static Collection<String> stopWords = new HashSet<String>(Arrays.asList(stopWordArray));
