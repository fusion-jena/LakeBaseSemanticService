 ...
 * @since 0.1
 */
public class LinkedNodeTrieSet extends AbstractSet<String> implements TrieSet {
	...
	@Override
	public boolean addAll(Collection<? extends String> c) throws ClassCastException {
	...
	public Iterator<String> iterator() {
		Iterator<? extends Trie<String>> visible = this.populatedNodeIterator();

		return new Iterator<String>() {
			private Iterator<? extends Trie<String>> populatedNodeIterator = visible;

			@Override
			public boolean hasNext() {
				return populatedNodeIterator.hasNext();
			}

			@Override
			public String next() {
				return populatedNodeIterator.next().key();
			}
		};
	}
	...
	/**
	 * Split the symbol of this node and move the content of this node into a
	 * new child node.
	 * 
	 * @param i
	...
	/**
	 * Move the content of this trie node into a new sibling node and give this
	 * trie node a new symbol. The resulting new key is not contained in the
	 * trie.
	 * 
	 * @param e
	 ...
	 * <em>get lost</em>. <code>size</code> and <code>lengths</code> of parent
	 * nodes will <em>not</em> be updated.
	 * </p>
	 */
	 ...
	 * <p>
	 * <b>Attention:</b><br>
	 * If this node has more than one child all children except the first child
	 * will get lost. If this trie node is contained, that information will get
	 * lost. <code>size</code> and <code>lengths</code> of parent nodes will
	 * <em>not</em> be updated.
	 * </p>
	 */
	...
	@Override
	public Trie<String> getSubTrie(String key) {
