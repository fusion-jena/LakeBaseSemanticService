...
public class Tries {
	...
	private static class EmptyTrie<V> implements Trie<V> {
		...
		public Trie<V> getSubTrie(String key) {
			return (Trie<V>) emptyTrie();
		}
	}

	private static class EmptyTrieMap<V> extends AbstractMap<String, V> implements TrieMap<V> {
		...
		@Override
		public Trie<V> getSubTrie(String key) {
			return (Trie<V>) emptyTrieMap();
		}
	}

	private static class EmptyTrieSet extends AbstractSet<String> implements TrieSet {
	...
	private static class SingletonTrieMap<V> extends AbstractMap<String, V> implements TrieMap<V> {
	...
	private static class SingletonTrieSet extends AbstractSet<String> implements TrieSet {
		...
		@Override
		public Trie<String> getSubTrie(String key) {
			if (this.element.startsWith(key)) {
				return this;
			} else {
				return emptyTrieSet();
			}
	...
	private static final TrieSet EMPTY_TRIE_SET = new EmptyTrieSet();
	private static final TrieMap<?> EMPTY_TRIE_MAP = new EmptyTrieMap<>();

	public static Trie<?> emptyTrie() {
		return EMPTY_TRIE;
	}

	public static TrieMap<?> emptyTrieMap() {
		return EMPTY_TRIE_MAP;
	}

	public static TrieSet emptyTrieSet() {
		return EMPTY_TRIE_SET;
	}
	...
	public static <V> TrieMap<V> singletonTrieMap(String key, V value) {
		return new SingletonTrieMap<V>(key, value);
	}

	public static TrieSet singletonTrieSet(String element) {
